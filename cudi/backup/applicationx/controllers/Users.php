...
class Users extends CI_Controller{
    ...
    */
    ...
    public function index(){
        $data['pageContent'] = $this->load->view('users/user', '', TRUE);
    ...
    */
    ...
    public function laus_(){
        ...
        $json['userTable'] = $this->load->view('users/userlist', $data, TRUE);//get view with populated customers table
    ...
    public function add(){
        ...
        if($this->form_validation->run() !== FALSE){
            ...
            $inserted = $this->user->add(set_value('firstName'), set_value('lastName'), set_value('email'), $hashedPassword, 
                set_value('role'), set_value('mobile'), set_value('addr'));
    ...
    public function update(){
        ...
        if($this->form_validation->run() !== FALSE){
            ...
            $updated = $this->user->update($user_id, set_value('firstName'), set_value('lastName'), set_value('email'),
                    set_value('mobile'), set_value('addr'), set_value('role'));
