...
if(is_cli()){
    ...
    $config['base_url'] =  $protocol.$host."/cudi/";
}

else{
    $allowed = ['cuditrader.com', 'www.cuditrader.com'];//input all allowed urls here e.g. amirsanni.com, www.practa.ng, smartagapp.com
