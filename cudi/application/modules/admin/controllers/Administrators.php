...
class Administrators extends CI_Controller{
    ...
    */
    ...
    public function index(){
        $data['pageContent'] = $this->load->view('admins/admin', '', TRUE);
    ...
    */
    ...
    public function laad_(){
        ...
        $json['adminTable'] = $this->load->view('admins/adminlist', $data, TRUE);//get view with populated customers table
