    ...
    <body>
        <nav class="navbar navbar-default hidden-print">
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?=admin_base_url()?>" style="margin-top:-15px">
                        <img src="<?=base_url()?>public/images/logo_cudi.jpeg" alt="logo" class="img-responsive" width="90px">
                    </a>
                </div>
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <ul class="nav navbar-nav navbar-left visible-xs">
                        ...
                        <li class="<?= $pageTitle == 'Transactions' ? 'active' : '' ?>">
                            <a href="<?= admin_site_url('transactions') ?>">
                        ...
                        <li class="<?= $pageTitle == 'Employees' ? 'active' : '' ?>">
                            <a href="<?= admin_site_url('employees') ?>">
                        ...
                        <li class="<?= $pageTitle == 'Eventlog' ? 'active' : '' ?>">
                            <a href="<?= admin_site_url('Eventlog') ?>">
                        ...
                        <li class="<?= $pageTitle == 'Database' ? 'active' : '' ?>">
                            <a href="<?= admin_site_url('dbmanagement') ?>">
                        ...
                        <li class="<?= $pageTitle == 'Administrators' ? 'active' : '' ?>">
                            <a href="<?= admin_site_url('administrators') ?>">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="dropdown">
                            <a>
                                Total Profit Earned Today: <b>&#8358;<span id="totalEarnedToday"></span></b>
                            </a>
                        </li>
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="divider"></li>--->
                                <li><a href="<?= admin_site_url('logout') ?>"><i class="fa fa-sign-out"></i> Logout</a></li>
                            </ul>
                        </li>
                    </ul>
                </div><!-- /.navbar-collapse -->
        ...
        <footer class="container-fluid text-center hidden-print">
            <p>
                ...
                Copyright <a href="http://#">Margin Tech Investments</a> (2018)
            </p>
        </footer>
