...
// require_once './application/modules/admin/controllers/functions.php';
...
class Genlib {
    ...
    public function checkLogin() {
        if (empty($_SESSION['admin_id'])) {
            ...
            redirect(admin_base_url() . '?red_uri=' . uri_string()); //redirects to login page
        } 
    ...
    public function setPaginationConfig($totalRows, $urlToCall, $limit, $attributes){
        $config = ['total_rows'=>$totalRows, 'base_url'=>admin_base_url().$urlToCall, 'per_page'=>$limit, 'uri_segment'=>3,
