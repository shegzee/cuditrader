...
$(document).ready(function(){
    ...
    $("#addAdminSubmit").click(function(e){
        ...
        $.ajax({
            method: "POST",
            url: adminRoot+"administrators/add",
    ...
    $("#editAdminSubmit").click(function(e){
        ...
        if(formChanges("editAdminForm")){
            ...
            $.ajax({
                method: "POST",
                url: adminRoot+"administrators/update",
    ...
    $("#adminSearch").on('keyup change', function(){
        ...
        if(value){//search only if there is at least one char in input
            $.ajax({
                type: "get",
                url: adminRoot+"search/adminsearch",
                data: {v:value},
    ...
    $("#allAdmin").on('click', '.suspendAdmin', function(){
        ...
        if(adminId){
            $.ajax({
                url: adminRoot+"administrators/suspend",
                method: "POST",
                data: {_aId:adminId}
            }).done(function(returnedData){
                if(returnedData.status === 1){
    ...
    */
    ...
    $("#allAdmin").on('click', '.deleteAdmin', function(){
        ...
        if(confirm){
            ...
            if(adminId){
                $.ajax({
                    url: adminRoot+"administrators/delete",
                    method: "POST",
                    data: {_aId:adminId}
                }).done(function(returnedData){
                    if(returnedData.status === 1){
...
function laad_(url){
    ...
    $.ajax({
        type:'get',
        url: url ? url : adminRoot+"administrators/laad_/",
