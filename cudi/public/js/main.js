...
var adminRoot = setAppRoot("admin", "admin");
...
function vtr_(elem){
    ...
    if(ref){
        ...
        //make server request
        $.ajax({
            url: adminRoot+"transactions/vtr_",
            type: "post",
            data: {ref:ref},
            success: function(returnedData){
                if(returnedData.status === 1){
...
function totalEarnedToday(){
    $.ajax({
        method:"POST",
        url: adminRoot+"misc/totalearnedtoday"
