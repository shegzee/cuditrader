...
class Transactions extends CI_Controller{
    ...
    */
    ...
    public function index(){
        ...
        $data['pageContent'] = $this->load->view('admin/transactions/transactions', $transData, TRUE);
    ...
    */
    ...
    public function latr_(){
        ...
        $json['transTable'] = $this->load->view('admin/transactions/transtable', $data, TRUE);//get view with populated transactions table
    ...
    */
    ...
    private function genTransReceipt($allTransInfo, $cumAmount, $_at, $_cd, $ref, $transDate, $_mop, $vatAmount, $vatPercentage, 
        ...
        $transReceipt = $this->load->view('admin/transactions/transreceipt', $data, TRUE);
    ...
    */
    ...
    public function report($from_date, $to_date=''){        
        ...
        $this->load->view('admin/transactions/transReport', $data);
    }
}
