...
class Items extends CI_Controller{
    ...
    public function index(){
        $data['pageContent'] = $this->load->view('admin/items/items', '', TRUE);
    ...
    */
    ...
    public function lilt(){
        ...
        $json['itemsListTable'] = $this->load->view('admin/items/itemslisttable', $data, TRUE);//get view with populated items table
