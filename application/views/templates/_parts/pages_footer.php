...
<img src="<?=base_url()?>public/images/footer-xs.jpg"  alt="">


  <div class="container">
    <div class="row">
      <div class="col-md-6">
        <div class="logo"><img src="<?=base_url()?>public/images/test_banner.png" alt="Cudi Trader banner logo (light)"></div>
        ...
        <div id="unchained-phone">
          <a data-category="contact-us" data-action="phone" data-label="from-footer" class="track-click" href="tel:+2348152457369"><!-- 0815 245 7369 --><?= $site_settings['phone']; ?></a>
        </div>
