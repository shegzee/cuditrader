...
<div class="container">
	...
	echo form_dropdown('bank_id', $banks, set_value('bank_id')).'<br />'; // $banks = array('id' => 'name')
	...
	echo form_dropdown('account_type_id', $account_types, set_value('account_type_id')).'<br />';
